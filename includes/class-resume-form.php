                ...
                <form method="POST" id="submit-resume-form" class="resume-manager-form" enctype="multipart/form-data">
                    ...
                    <div id="employeeDetails" class="ae_form_card">
                        ...
                        <fieldset class="fieldset-candidate_photo fieldset-type-file">
                            <label for="candidate_photo" class="ae_label"><?php esc_html_e('Upload Photo (JPG, PNG)', 'wp-resume-manager'); ?></label>
                            <input type="file" name="candidate_photo" id="candidate_photo" accept="image/jpeg,image/png" />
                            <?php if ($candidate_photo): ?>
                                <input type="hidden" name="candidate_photo_current" value="<?php echo esc_attr($candidate_photo); ?>" />
                                <p><?php esc_html_e('Current Photo:', 'wp-resume-manager'); ?> <a href="<?php echo esc_url($candidate_photo); ?>" target="_blank"><?php esc_html_e('View Photo', 'wp-resume-manager'); ?></a></p>
                            <?php endif; ?>
                        </fieldset>
                        ...
                        <fieldset class="fieldset-resume_title fieldset-type-title">
                            <label for="resume_title" class="ae_label"><?php esc_html_e('Employee Name', 'wp-resume-manager'); ?></label>
                            <input type="text" name="resume_title" class="ae_input" id="resume_title" value="<?php echo esc_attr($resume_title); ?>" required />
                        </fieldset>

                        <!-- Professional Title Field -->
                        <fieldset class="fieldset-professional_title fieldset-type-title half_field">
                            <label for="professional_title" class="ae_label"><?php esc_html_e('Role', 'wp-resume-manager'); ?></label>
                            <input type="text" name="professional_title" class="ae_input" id="professional_title" value="<?php echo esc_attr($professional_title); ?>" />
                        </fieldset>

                        <!-- Right to Work Select Field -->
                        <fieldset class="fieldset-right_to_work fieldset-type-select half_field">
                            <label for="right_to_work" class="ae_label"><?php esc_html_e('Right to Work', 'job_manager'); ?></label>
                        ...
                        <fieldset class="fieldset-resume_description fieldset-type-description">
                            <label for="resume_description" class="ae_label" style="margin-bottom: -30px;"><?php esc_html_e('Resume Description', 'wp-resume-manager'); ?></label>
                            <?php
                            wp_editor(
                                $resume_description,
                                'resume_description',
                        ...
                        <fieldset class="fieldset-resume_file fieldset-type-file">
                            <label for="resume_file" class="ae_label"><?php esc_html_e('Upload Resume (PDF only)', 'wp-resume-manager'); ?></label>
                            <input type="file" name="resume_file" id="resume_file" accept="application/pdf" />
                            <?php if ($resume_file): ?>
                                <p><?php esc_html_e('Current Resume:', 'wp-resume-manager'); ?> <a href="<?php echo esc_url($resume_file); ?>"><?php echo esc_html(basename($resume_file)); ?></a></p>
                            <?php endif; ?>
                        </fieldset>
                    </div>
                    ...
                    <div id="careerHistory" class="ae_form_card">
                        <h4 class="ae_form_card-title">
                            ...
                            <a href="javascript:void(0);" id="add-experience"><?php esc_html_e('Add Experience', 'wp-resume-manager'); ?></a>
                        </h4>
                            ...
                            <div id="career-history-template" style="display: none;">
                                <div class="career-history-entry">
                                    <fieldset class="fieldset-resume_employer fieldset-type-employer">
                                        ...
                                        <input class="ae_input" type="text" name="candidate_experience[new][employer]" id="new_employer" value="" />
                                    </fieldset>
                                    ...
                                    <fieldset class="fieldset-resume_job_title fieldset-type-job-title half_field">
                                        ...
                                        <input class="ae_input" type="text" name="candidate_experience[new][job_title]" id="new_job_title" value="" />
                                    </fieldset>

                                    <fieldset class="fieldset-resume_date fieldset-type-date half_field">
                                        <label class="ae_label" for="new_date">Start/End Date</label>
                                        <input class="ae_input" type="text" name="candidate_experience[new][date]" id="new_date" value="" />
                                    </fieldset>

                                    <fieldset class="fieldset-resume_notes fieldset-type-notes">
                                        <label class="ae_label" for="new_notes">Notes</label>
                                        <textarea class="ae_input" name="candidate_experience[new][notes]" id="new_notes"></textarea>
                                    </fieldset>
                            ...
                            <?php if (!empty($candidate_experience)) : ?>
                                <?php foreach ($candidate_experience as $index => $experience) : ?>
                                    <div class="career-history-entry">
                                        <!-- Employer -->
                                        <fieldset class="fieldset-resume_employer fieldset-type-employer">
                                            <label class="ae_label" for="employer_<?php echo $index; ?>"><?php esc_html_e('Employer', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="candidate_experience[<?php echo $index; ?>][employer]" id="employer_<?php echo $index; ?>" value="<?php echo esc_attr($experience['employer']); ?>" required />
                                        </fieldset>

                                        <!-- Job Title -->
                                        <fieldset class="fieldset-resume_job_title fieldset-type-job-title half_field">
                                            <label class="ae_label" for="job_title_<?php echo $index; ?>"><?php esc_html_e('Job Title', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="candidate_experience[<?php echo $index; ?>][job_title]" id="job_title_<?php echo $index; ?>" value="<?php echo esc_attr($experience['job_title']); ?>" required />
                                        </fieldset>

                                        <!-- Start/End Date -->
                                        <fieldset class="fieldset-resume_date fieldset-type-date half_field">
                                            <label class="ae_label" for="date_<?php echo $index; ?>"><?php esc_html_e('Start/End Date', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input ae_datepicker" type="text" name="candidate_experience[<?php echo $index; ?>][date]" id="date_<?php echo $index; ?>" value="<?php echo esc_attr($experience['date']); ?>" />
                                        ...
                                        <!-- Notes -->
                                        <fieldset class="fieldset-resume_notes fieldset-type-notes">
                                            <label class="ae_label" for="notes_<?php echo $index; ?>"><?php esc_html_e('Notes', 'wp-resume-manager'); ?></label>
                                            <textarea class="ae_input" name="candidate_experience[<?php echo $index; ?>][notes]" id="notes_<?php echo $index; ?>" rows="5"><?php echo esc_attr($experience['notes']); ?></textarea>
                                        </fieldset>

                                        <a href="javascript:void(0);" class="remove-experience"><?php esc_html_e('Remove Experience', 'wp-resume-manager'); ?></a>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div id="education" class="ae_form_card">
                        <h4 class="ae_form_card-title">
                            ...
                            <a href="javascript:void(0);" id="add-education"><?php esc_html_e('Add Education', 'wp-resume-manager'); ?></a>
                        </h4>
                            ...
                            <div id="education-history-template" style="display: none;">
                                <div class="education-history-entry">
                                    <fieldset class="fieldset-resume_location fieldset-type-location">
                                        ...
                                        <input class="ae_input" type="text" name="candidate_education[new][location]" id="new_location" value="" />
                                    </fieldset>
                                    ...
                                    <fieldset class="fieldset-resume_qualification fieldset-type-job-qualification half_field">
                                        ...
                                        <input class="ae_input" type="text" name="candidate_education[new][qualification]" id="new_qualification" value="" />
                                    </fieldset>

                                    <fieldset class="fieldset-resume_date fieldset-type-date half_field">
                                        <label class="ae_label" for="new_date">Start/End Date</label>
                                        <input class="ae_input" type="text" name="candidate_education[new][date]" id="new_date" value="" />
                                    </fieldset>

                                    <fieldset class="fieldset-resume_notes fieldset-type-notes">
                                        <label class="ae_label" for="new_notes">Notes</label>
                                        <textarea class="ae_input" name="candidate_education[new][notes]" id="new_notes"></textarea>
                                    </fieldset>
                            ...
                            <?php if (!empty($candidate_education)) : ?>
                                <?php foreach ($candidate_education as $index => $education) : ?>
                                    <div class="education-history-entry">
                                        <!-- Employer -->
                                        <fieldset class="fieldset-resume_location fieldset-type-location">
                                            <label class="ae_label" for="location_<?php echo $index; ?>"><?php esc_html_e('Institution', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="candidate_education[<?php echo $index; ?>][location]" id="location_<?php echo $index; ?>" value="<?php echo esc_attr($education['location']); ?>" required />
                                        </fieldset>

                                        <!-- Job Title -->
                                        <fieldset class="fieldset-resume_qualification fieldset-type-job-qualification half_field">
                                            <label class="ae_label" for="qualification_<?php echo $index; ?>"><?php esc_html_e('Certification(s)', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="candidate_education[<?php echo $index; ?>][qualification]" id="qualification_<?php echo $index; ?>" value="<?php echo esc_attr($education['qualification']); ?>" required />
                                        </fieldset>

                                        <!-- Start/End Date -->
                                        <fieldset class="fieldset-resume_date fieldset-type-date half_field">
                                            <label class="ae_label" for="date_<?php echo $index; ?>"><?php esc_html_e('Start/End Date', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input ae_datepicker" type="text" name="candidate_education[<?php echo $index; ?>][date]" id="date_<?php echo $index; ?>" value="<?php echo esc_attr($education['date']); ?>" />
                                        </fieldset>

                                        <!-- Notes -->
                                        <fieldset class="fieldset-resume_notes fieldset-type-notes">
                                            <label class="ae_label" for="notes_<?php echo $index; ?>"><?php esc_html_e('Notes', 'wp-resume-manager'); ?></label>
                                            <textarea class="ae_input" name="candidate_education[<?php echo $index; ?>][notes]" id="notes_<?php echo $index; ?>" rows="5"><?php echo esc_attr($education['notes']); ?></textarea>
                                        </fieldset>

                                        <a href="javascript:void(0);" class="remove-education"><?php esc_html_e('Remove Education', 'wp-resume-manager'); ?></a>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div id="lisencesCertifications" class="ae_form_card">
                        <h4 class="ae_form_card-title">
                            ...
                            <a href="javascript:void(0);" id="add-certification"><?php esc_html_e('Add Certification', 'wp-resume-manager'); ?></a>
                        </h4>
                            ...
                            <div id="certifications-history-template" style="display: none;">
                                <div class="certifications-history-entry">
                                    <fieldset class="fieldset-resume_licence_name fieldset-type-licence_name half_field">
                                        ...
                                        <input class="ae_input" type="text" name="resume_certifications[new][licence_name]" id="licence_name" value="" />
                                    </fieldset>
                                    ...
                                    <fieldset class="fieldset-resume_licence_issuer fieldset-type-job-licence_issuer half_field">
                                        ...
                                        <input class="ae_input" type="text" name="resume_certifications[new][licence_issuer]" id="licence_issuer" value="" />
                                    </fieldset>
                                    ...
                                    <fieldset class="fieldset-resume_issue_date fieldset-type-issue_date half_field">
                                        ...
                                        <input class="ae_input" type="date" name="resume_certifications[new][issue_date]" id="issue_date" value="" />
                                    </fieldset>
                                    ...
                                    <fieldset class="fieldset-resume_expiry_date fieldset-type-expiry_date half_field">
                                        ...
                                        <input class="ae_input" type="date" name="resume_certifications[new][expiry_date]" id="expiry_date" value="" />
                                    </fieldset>
                            ...
                            <?php if (!empty($resume_certifications)) : ?>
                                <?php foreach ($resume_certifications as $index => $certification) : ?>
                                    <div class="certifications-history-entry">
                                        <!-- Employer -->
                                        <fieldset class="fieldset-resume_licence_name fieldset-type-licence_name half_field">
                                            <label class="ae_label" for="licence_name_<?php echo $index; ?>"><?php esc_html_e('Certification Name', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="resume_certifications[<?php echo $index; ?>][licence_name]" id="licence_name_<?php echo $index; ?>" value="<?php echo esc_attr($certification['licence_name']); ?>" required />
                                        </fieldset>

                                        <!-- Job Title -->
                                        <fieldset class="fieldset-resume_licence_issuer fieldset-type-job-licence_issuer half_field">
                                            <label class="ae_label" for="licence_issuer<?php echo $index; ?>"><?php esc_html_e('Certification Issuer', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="text" name="resume_certifications[<?php echo $index; ?>][licence_issuer]" id="licence_issuer_<?php echo $index; ?>" value="<?php echo esc_attr($certification['licence_issuer']); ?>" required />
                                        </fieldset>

                                        <!-- Start Date -->
                                        <fieldset class="fieldset-resume_issue_date fieldset-type-issue_date half_field">
                                            <label class="ae_label" for="issue_date_<?php echo $index; ?>"><?php esc_html_e('Certification Issue Date', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="date" name="resume_certifications[<?php echo $index; ?>][issue_date]" id="issue_date_<?php echo $index; ?>" value="<?php echo esc_attr($certification['issue_date']); ?>" />
                                        </fieldset>

                                        <!-- End Date -->
                                        <fieldset class="fieldset-resume_expiry_date fieldset-type-expiry_date half_field">
                                            <label class="ae_label" for="expiry_date_<?php echo $index; ?>"><?php esc_html_e('Certification Expiry Date', 'wp-resume-manager'); ?></label>
                                            <input class="ae_input" type="date" name="resume_certifications[<?php echo $index; ?>][expiry_date]" id="expiry_date_<?php echo $index; ?>" value="<?php echo esc_attr($certification['expiry_date']); ?>" />
                                        </fieldset>

                                        <a href="javascript:void(0);" class="remove-certification"><?php esc_html_e('Remove Certification', 'wp-resume-manager'); ?></a>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div id="professionalSkills" class="ae_form_card">
                        ...
                        <fieldset class="fieldset-resume_skills fieldset-type-skills">
                            <label class="ae_label" for="resume_skills"><?php esc_html_e('Skills', 'wp-resume-manager'); ?></label>
                            <input type="text" id="resume_skills_input" placeholder="Type and press enter to add skills" class="ae_input" />
                            ...
                            <input type="hidden" name="resume_skills" id="resume_skills" value="<?php echo esc_attr(implode(',', $selected_skills)); ?>" />
                        </fieldset>
                    </div>

                    <!-- Save and Cancel Buttons -->
                    <div class="add_resume-form-btns">
                        <a href="javascript:void(0);" onclick="history.back();" class="cancel-btn"><?php esc_attr_e('Cancel', 'wp-resume-manager'); ?></a>
                        <?php if ($resume_status === 'draft' || !$resume_id) : ?>
                            <input type="submit" name="resume_submit" class="button button-primary" value="<?php esc_attr_e('Publish', 'wp-resume-manager'); ?>" />
                            <input type="submit" name="save_draft" class="button button-secondary" value="<?php esc_attr_e('Save Draft', 'wp-resume-manager'); ?>" />
                        <?php else: ?>
                            <input type="submit" name="resume_submit" class="button button-primary" value="<?php esc_attr_e('Save', 'wp-resume-manager'); ?>" />
                        <?php endif; ?>
                    </div>
                </form>
            </div>
